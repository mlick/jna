...
public abstract class MouseEventReceiver extends DeviceEventReceiver<MouseHookManager> implements LowLevelMouseProc {
     ...
     *
     * @param type Type is press <i>(Left, Right, Middle)</i>
     * @param hwnd Window handle that receives the event.
     * @param info Mouse information.
     ...
     *
     * @param down Scroll event is down <i>(Negative movement)</i>
     * @param hwnd Window handle that receives the event.
     * @param info Mouse information.
     * @return Event cancellation
     */
